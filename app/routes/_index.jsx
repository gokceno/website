      ...
      <div className="container">
        <div className="contents">
          ...
          <div className="contentsText">
            <p>
              ...
              am passionate about exploring the evolving world of technology and
        ...
        <div className="experience">
          ...
          <div className="experience-detail second">
            <div className="company-name">
              <a
                href="https://www.beforesunset.ai/"
                target="_blank"
                rel="noopener noreferrer"
              >
                beforesunset.ai
          ...
          <div className="view-all">
            <a
              href="https://www.linkedin.com/in/gokcen-ogutcu/"
              target="_blank"
              rel="noopener noreferrer"
            >
              View All
